...
describe NylasLegacy::SchedulerCollection do
  describe "ProviderAvailability" do
    it "(getGoogleAvailability) should call the correct endpoint" do
      ...
      scheduler_collection = described_class.new(model: NylasLegacy::Scheduler, api: api)
  ...
  describe "Public Booking API" do
    it "(getPageBySlug) should return a Scheduler type" do
      ...
      api = instance_double(NylasLegacy::API, execute: scheduler_json)
      scheduler_collection = described_class.new(model: NylasLegacy::Scheduler, api: api)
    ...
    it "(getAvailableTimeSlots) should return an array of SchedulerTimeSlot" do
      ...
      api = instance_double(NylasLegacy::API, execute: scheduler_time_slots)
      scheduler_collection = described_class.new(model: NylasLegacy::Scheduler, api: api)
    ...
    describe "SchedulerBookingConfirmation" do
      it "(bookTimeSlot) should return a SchedulerBookingConfirmation type" do
        ...
        api = instance_double(NylasLegacy::API, execute: booking_confirmation)
        scheduler_collection = described_class.new(model: NylasLegacy::Scheduler, api: api)

        slot = NylasLegacy::SchedulerTimeSlot.new(
          account_id: "test-account-id",
          calendar_id: "test-calendar-id",
        ...
        timeslot_to_book = NylasLegacy::SchedulerBookingRequest.new(
          additional_values: {
            test: "yes"
          },
